    ...
    <div>
      ...
      <div class="row justify-content-center align-items-stretch">
        ...
        <div class="col-md-3">
          <div class="card" style="margin-top: 10px;">
            <div class="card-body">
              <h4 class="card-title text-center" style="color: #696969; font-weight: bold;">Hospedagem 2</h4>
              <div style="text-align:center;">
                <h2 style="color: #FF1493; font-weight: bold;"><span class="currency">R$</span>499/mês</h2>
              </div>
              <p style="color: grey; text-align: center;">cobrado mensalmente<br> sem taxa de setup</p>
              <hr>
              <p style="color: grey; font-size: 1.2em; text-align: center;">Ideal para site com mais <br>de 30k de
                visitas.
              </p>
              <hr>
